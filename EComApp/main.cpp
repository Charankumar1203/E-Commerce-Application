...
void shopping(string MasterPin, Flipkart &charansFlipkart, user* User)
{
    while (User->isUserLoggedIn())
    {
        ...
        {
        item* additem = charansFlipkart.returnCopyItem(itemnumber);
        if(additem != NULL){
...
int main()
{
    ...
    cout << "Enter Master Pin for the charansFlipkart : ";
    cin >> MasterPin;
    ...
    Flipkart charansFlipkart(MasterPin, fileName);

    while (true)
    {
        char type;
        system("clear");
        cout << "WELCOME TO Charan'S FLIPKART\n\n";
        ...
        if(type == 'S')
        {
            ...
            charansFlipkart.registerNewUser(emailId, pass, uname);
        ...
        TOGOHOME:
            ...
            user *User = charansFlipkart.userLogin(emailId, pass);
            if(User != NULL){
                cout << "\nHey " << uname << ", welcome to Charan's Flipkart\n";
                shopping(MasterPin, charansFlipkart, User);
            }
            ...
            system("clear");
            user *User = charansFlipkart.userLogin(emailId, Password);
            if(User != NULL){
                cout << "\t\tWelcome " << User->getUserName() << " to charansFlipkart\n";
                shopping(MasterPin, charansFlipkart, User);
            }
            ...
            system("clear");
            charansFlipkart.login_owner(MasterPin);
            while (charansFlipkart.isLoggedIn())
            {
                system("clear");
                int input;
                cout << "Welcome Charan!, enter any of the following number for an operation: \n";
                cout << "\nEnter -1 to logout\n";
                ...
                if (input == 0)
                {
                    ...
                    charansFlipkart.addItemToShop(prod, quantity, price);
                    cout << "\nTHe product has been added successfully.\n";

                }
                else if (input == -1)
                {
                    charansFlipkart.logout_acc();
                }
                else if (input == 2)
                {
                    int index;
                    ...
                    charansFlipkart.removeItemFromShop(index);
                }
                else if (input == 1)
                {
                    charansFlipkart.printItemList();
        ...
        else if (type == 'E')
        {
            ...
            cout << "Enter Master Pin : ";
            cin >> masterPin;
            charansFlipkart.exit(MasterPin);
            exit(0);
        }
        else
        {
